...
#End Region
    ...
    Public Sub New()
        ...
        MyBase.m_category = "Grafica DM según Código"  'localizable text 
        MyBase.m_caption = "Grafica DM según Código"   'localizable text 
        MyBase.m_message = "Grafica DM según Código"   'localizable text 
        MyBase.m_toolTip = "Grafica DM según Código" 'localizable text 
        MyBase.m_name = "Grafica DM según Código"  'unique id, non-localizable (e.g. "MyCategory_ArcMapCommand")
