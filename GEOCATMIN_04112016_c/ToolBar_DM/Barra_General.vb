...
#End Region
    ...
    Public Sub New()
        ...
        AddItem(New Guid("636a7dec-b3e7-4699-ace1-029abd0692ed"), 1) 'Graficar Excel
        AddItem(New Guid("de52ff67-5344-4657-a138-59348cc8ad7c"), 1) 'Generar Planos DM masivos
        'AddItem(New Guid("e2e20f5f-94d1-4364-b874-da8139d2f204"), 1) 'Calcula ARES.
