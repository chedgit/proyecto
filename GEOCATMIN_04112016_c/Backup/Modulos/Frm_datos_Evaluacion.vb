...
Public Class Frm_datos_Evaluacion
    ...
    Private Sub btnGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        ...
        If cboInforme.SelectedValue = " " Then
            MsgBox("Seleccione Tipo de Informe: ....", vbExclamation, "[BDGeocientífica]")
            cboInforme.Focus()
            Exit Sub
        End If
        glo_InformeDM = cboInforme.SelectedValue
        lostrVerifica = cls_Oracle.FT_VERIFICA_CODIGO(v_codigo, cboInforme.SelectedValue)
        ...
        Select Case lostrOpcion
            ...
            Case "6" 'Si, Generar Histórico y Grabar la Información.
                lostrVerifica = cls_Oracle.FT_GENERA_HISTORICO(v_codigo, cboInforme.SelectedValue)
            Case "7" 'No, Actualizar la Información.
                lostrElimina = cls_Oracle.FT_ELIMINA_INFORME_TECNICO(v_codigo, cboInforme.SelectedValue)
        End Select
            ...
            If chkbox.Checked Then ' AndAlso CType(sender, Windows.Forms.CheckBox).Name <> chkbox.Name Then
                Select Case chkbox.Name
                    Case "Check_dato1"
                        ...
                        vCodEVACheck = vCodEVACheck & conta + 1 & "|" & txtCodigo.Text & "||"
                    Case "Check_dato2"
        ...
        'Prioritarios
        lostrRetorno = cls_Oracle.FT_SG_D_CARAC_EVALGIS("INS", txtCodigo.Text, cboInforme.SelectedValue, vCodEVA, vPrioridad, "", "", "", gstrUsuarioAcceso)
        ...
        If txtfrontera.Text <> "" Then
            ...
            lostrRetorno = cls_Oracle.FT_SG_D_CARAC_EVALGIS("INS", txtCodigo.Text, cboInforme.SelectedValue, " 1| " & txtCodigo.Text & " || ", " 1| " & "LF" & " || ", " 1| " & txtfrontera.Text & " || ", " 1|" & loValorFrontera & "||", "", gstrUsuarioAcceso)
        End If
        If Val(lostrRetorno) > 0 Then
            MsgBox("La operación se realizó exitosamente.", vbExclamation, "[BDGeocientífica]")
            glo_Tool_EVA_02 = True
        Else
            MsgBox("No se pudo completar la operación, ya existe el Código", vbExclamation, "[BDGeocientífica]")
    ...
    Private Sub Check_dato20_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Check_dato20.CheckedChanged
        If Check_dato20.Checked = True Then
            txt_dato20.Visible = True
        Else
            txt_dato20.Text = ""
            txt_dato20.Visible = False
        End If
    End Sub
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        ...
        If lostrRetorno = 1 Then
            var_fa_tipoactualiza = False  'Solo ingreso para utilizar en Areas Superpuestas
            ...
            If lostrCheck <> "" Then
                vCodEVA = vCodEVACheck
                'lostrRetorno = cls_Oracle.FT_SG_D_CARAC_EVALGIS("INS", txtCodigo.Text, cboInforme.SelectedValue, vCodEVA, lostrCheck, "", "", "", gstrUsuarioAcceso)
                lostrRetorno = cls_Oracle.FT_SG_D_CARAC_EVALGIS("INS", txtCodigo.Text, cboInforme.SelectedValue, " 1| " & txtCodigo.Text & " || ", lostrCheck, vCodEVACheck, "", "", gstrUsuarioAcceso)
            ...
            If txtfrontera.Text <> "" Then
                ...
                lostrRetorno1 = cls_Oracle.FT_SG_D_CARAC_EVALGIS("INS", txtCodigo.Text, cboInforme.SelectedValue, " 1| " & txtCodigo.Text & " || ", " 1| " & "LF" & " || ", " 1| " & txtfrontera.Text & " || ", " 1|" & loValorFrontera & "||", "", gstrUsuarioAcceso)
            End If
            If Val(lostrRetorno) > 0 Then
        ...
        ElseIf lostrRetorno = 0 Then
            ...
            Select Case lostrOpcion1
                ...
                Case "7" 'No Genera Histotico pero si Graba la informacion reemplanzandola
                    ...
                    lostrRetorno_eli = cls_Oracle.FT_SG_D_EVALGIS("DEL", txtCodigo.Text, cboInforme.SelectedValue, gstrCodigo_Usuario)
                    var_fa_tipoactualiza = True  'Solo Actualizacion para utilizar en Areas Superpuestas
                ...
                If chkbox.Checked Then ' AndAlso CType(sender, Windows.Forms.CheckBox).Name <> chkbox.Name Then
                    Select Case chkbox.Name
                        Case "Check_dato1"
                            ...
                            vCodEVACheck1 = vCodEVACheck1 & conta1 + 1 & "|" & txtCodigo.Text & "||"
                        Case "Check_dato2"
            ...
            If lostrRetorno_eli = 1 Then
                lostrRetorno_act = cls_Oracle.FT_SG_D_EVALGIS("ACT", txtCodigo.Text, cboInforme.SelectedValue, gstrCodigo_Usuario)

                'Prioritarios
                lostrRetorno_act = cls_Oracle.FT_SG_D_CARAC_EVALGIS("ACT", txtCodigo.Text, cboInforme.SelectedValue, vCodEVA1, vPrioridad1, "", "", "", gstrUsuarioAcceso)
                'Caracteristicas checks
                If lostrCheck <> "" Then
                    vCodEVA = vCodEVACheck
                    ...
                    lostrRetorno_act = cls_Oracle.FT_SG_D_CARAC_EVALGIS("ACT", txtCodigo.Text, cboInforme.SelectedValue, " 1| " & txtCodigo.Text & " || ", lostrCheck1, vCodEVACheck, "", "", gstrUsuarioAcceso)
                ...
                If txtfrontera.Text <> "" Then
                    Dim loValorFrontera As Single = Single.Parse(Mid(txtfrontera.Text, 1, InStr(txtfrontera.Text, "(") - 2))
                    Dim lostrRetorno1 As String
                    lostrRetorno1 = cls_Oracle.FT_SG_D_CARAC_EVALGIS("ACT", txtCodigo.Text, cboInforme.SelectedValue, " 1| " & txtCodigo.Text & " || ", " 1| " & "LF" & " || ", " 1| " & txtfrontera.Text & " || ", " 1|" & loValorFrontera & "||", "", gstrUsuarioAcceso)
                End If
