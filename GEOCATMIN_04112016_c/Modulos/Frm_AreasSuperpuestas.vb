...
Public Class Frm_AreasSuperpuestas
    ...
    Private Sub btnGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        ...
        If Val(v_EstadoAI) > 0 Or v_EstadoAD > 0 Then
            MsgBox("La operación se realizó exitosamente para este cálculo.", vbExclamation, "Geocatmin")
            var_fa_AreaSuper = True
        Else
            var_fa_AreaSuper = False
            MsgBox("No se pudo completar la operación, código " & v_codigo & " ya esta Almacenado ", vbExclamation, "Geocatmin")
        End If
    End Sub
