    ...
    Private Sub Generar_Zona_Urbana()
        ...
        If v_tipo_exp = "PE" Then
            ...
            If lodbtExisteAR.Rows.Count >= 1 Then
                ...
                Next A
                If Not aFound1 Then
                    MsgBox("EL DM no se encuentra superpuesto a la capa generada de Zonas Urbanas para generar esta opción", MsgBoxStyle.Information, "[GEOCATMIN]")
                    Exit Sub
                End If
                'cls_eval.consultacapaDM("", "URBANA", "Area_Urbana_" & fecha_archi)
                'consulta a la capa
                ...
                If capa_sele.Count = 0 Then
                    MsgBox("No hay Areas Urbanas en este vista que se superponen el DM ", MsgBoxStyle.Critical, "Observación...")
                    Exit Sub
                Else
