...
#End Region
    ...
    Public Overrides Sub OnClick()
        ...
        'Dim cls_Google_Earth As New cls_Google_Earth
        'cls_Google_Earth.Genera_KML_Google(m_application, v_zona_dm)
        'Dim cadena As String

        'cadena = InputBox("Proceso Calculo de Demarcacion Libre Denunciabilidad", "Ingrese Fecha LD:", "20110930")
        'If cadena = "" Then
        'MsgBox("No ingreso fecha correctamente ", MsgBoxStyle.Critical, "BDGEOCATMIN")
        'Exit Sub
        'Else

        'End If
        'TODO: Add btn_Ver_Google.OnClick implementation
    End Sub
End Class
