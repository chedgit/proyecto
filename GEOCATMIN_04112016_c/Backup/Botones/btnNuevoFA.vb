...
#End Region
    ...
    Public Overrides Sub OnClick()
        ...
        If v_Informe <> "0" Then
            lostrOpcion = MsgBox("¿ Desea Generar Histórico del Código = " & v_codigo & "? ", MsgBoxStyle.YesNo, "BDGEOCATMIN - Histórico")
            Select Case lostrOpcion
                Case "7" 'Cancel
                    Exit Sub
                Case "6"
                    lostrVerifica = cls_Oracle.FT_GENERA_HISTORICO(v_codigo, v_Informe)
                    MsgBox("Se genero histórico del Código = " & v_codigo, MsgBoxStyle.Information, "Formatos Automáticos")
            End Select
        Else
