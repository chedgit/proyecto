...
Public Class frm_Grafica_Consulta_XY
        ...
        If pSelectionSet.Count > 0 Then
            ...
            Do Until pFeature Is Nothing
                ...
                ElseIf pFeatureLayer.Name = "Catastro" Then
                    ...
                    dRow.Item("AREA") = Format(Math.Round(pFeature.Value(pFeature.Fields.FindField("HECTAGIS")), 4), "###,###.#000")
                    'dRow.Item("AREA") = Area_utm
                Else



                    If pFeature.Fields.FindField("FID") = -1 Then
                        dRow.Item("NUMERO") = pFeature.Value(pFeature.Fields.FindField("OBJECTID"))
                        buscar_campo_fid = "OBJECTID"
                    Else
                        dRow.Item("NUMERO") = pFeature.Value(pFeature.Fields.FindField("FID"))
                        buscar_campo_fid = "FID"
    ...
    Private Sub dgdDetalle_RowColChange(ByVal sender As Object, ByVal e As C1.Win.C1TrueDBGrid.RowColChangeEventArgs) Handles dgdDetalle.RowColChange
        Select Case caso_opcion_tools
            ...
            Case "Por XY"
                ...
                ElseIf pFeatureLayer.Name = "Areadispo_" & v_codigo Then
                    cls_Catastro.Seleccionar_Items_x_Codigo("CODIGOU = '" & dgdDetalle.Item(dgdDetalle.Row, "CODIGO") & "'" & " And FID = " & dgdDetalle.Item(dgdDetalle.Row, "NUMERO"), pApp, Me.lstCoordenada)
                    Me.dgdResultado.Visible = False
                ...
                Else
                    ...
                    cls_Catastro.Seleccionar_Items_x_Codigo(buscar_campo_fid & " = " & dgdDetalle.Item(dgdDetalle.Row, "NUMERO"), pApp, Me.lstCoordenada)
    ...
    Private Sub gpx_DataDM_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles gpx_DataDM.Enter
